...
The website is built using React as a SPA and deployed on Netlify. Netlify Serverless Functions are used for handling server-side logic and API calls. Authentication is implemented using Auth0, Payments are processed using Stripe, and the data is fetched from Airtable Headless CMS.
